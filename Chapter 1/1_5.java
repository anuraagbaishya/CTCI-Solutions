/*
	...
	Method to perform basic string compression using counts of repeated characters
	For example aabcccccaaa would be a2b1c5a3
	Return original string if length of compressed string is not less than original
